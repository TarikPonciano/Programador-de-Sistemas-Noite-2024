        ...
        while (true) {
            ...
            if (op.equals("1")) {
                ...
                try {
                    ...
                    System.out
                            .println("Matricula | Nome | CPF | Data de Nascimento | Ano de Matricula | Média | Faltas");
                    ...
                    while (rs.next()) {
                        ...
                        System.out.printf("%d | %s | %s | %s | %d | %.1f | %d\n", matricula, nome, cpf, dataNascimento,
                                anoMatricula, media, faltas);
                    }

                    // Peça ao usuário o número de matrícula de um aluno e exiba na tela as
                    // informações do aluno no formato:
                    // Nome: <nome do aluno>
                    ...
                    if (rs.next()) {
                        ...
                        // Verificar a média. Se for igual ou acima de 7 imprima aprovado, se não
                        // imprima reprovado
                        String situacao;
